...
local mappingsV3 = {
    ...
    {"<leader>sc", desc="Continue", "<cmd>DapContinue<cr>"},
    {"<leader>sb", desc="Breakpoint", "<cmd>DapToggleBreakpoint<cr>"},
    {"<leader>sn", desc="Step next", "<cmd>DapStepOver<cr>"},
    {"<leader>si", desc="Step into", "<cmd>DapStepInto<cr>"},
    {"<leader>so", desc="Step out", "<cmd>DapStepOut<cr>"},
    {"<leader>st", desc="Debug nearest test", "<cmd>lua require('neotest').run.run({strategy= 'dap'})<cr>"},
    {"<leader>sq", desc="Quit debug session", "<cmd>DapTerminate<cr>"},
