Preferences = {
    ...
    linters = {"black", "prettier", "flake8", "mypy", "isort", "eslint-lsp", "djlint" },
    languageServers = { "bashls", "dockerls", "graphql", "ts_ls", "marksman", "pyright", "terraformls", "yamlls", "jsonls", "html", "cssls"},
